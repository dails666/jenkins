...
def should_sell_not_sell(source_id, cmid, item_cat1_ignores, days_delay):

    sql = '''
        SELECT
        t_sale.foreign_store_id as foreign_store_id,
        t_sale.foreign_item_id as foreign_item_id,
        t_date.d as out_of_stock_days,
        ...
        and (t_avg.m = 0 or t_avg.m is null)
